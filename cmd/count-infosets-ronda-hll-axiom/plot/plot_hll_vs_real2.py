...
hll_axiom = parse_utils.parse_structured_log("cmd/count-infosets-ronda-hll-axiom/plot/axiom-d14-anull-irb-l600.log")
hll_duvall = parse_utils.parse_structured_log("cmd/count-infosets-ronda-hll-axiom/plot/clarkduvall-d14-anull-irb-l600.log")
