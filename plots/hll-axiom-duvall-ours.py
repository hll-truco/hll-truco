...
hll_axiom = parse_utils.parse("logs/count-infosets-ronda-hll/axiom-d14-anull-irb-l600.log")
hll_duvall_pp = parse_utils.parse("logs/count-infosets-ronda-hll/clarkduvall-++-d14-anull-irb-l600.log")
hll_duvall = parse_utils.parse("logs/count-infosets-ronda-hll/clarkduvall-d14-anull-irb-l600.log")
hll_hll = parse_utils.parse("logs/count-infosets-ronda-hll/hll-d14-anull-irb-l600.log")
